 ...
 */
export function generateK6Script(apiDetails, options = {}) {
    const { vus = 10, duration = '30s', iterations, thresholds = ['p(95)<800'], sleepDuration = 1 } = options;
