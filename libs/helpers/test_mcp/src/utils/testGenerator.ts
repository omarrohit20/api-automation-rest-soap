...
import type { ApiDetails, TestCase } from '../types.js';
...
export function generateRSpecTests(apiDetails: ApiDetails, options: GenerateOptions): string {
...
function generateFunctionalTests(apiDetails: ApiDetails, resourceName: string, context?: any): string[] {
  const lines: string[] = [];
...
function generateComponentTests(apiDetails: ApiDetails, resourceName: string, context?: any): string[] {
  const lines: string[] = [];
